...
class Zombie(pygame.sprite.Sprite):
    ...
    def update(self, dt):
        ...
        head_rect_right = pygame.FRect(self.rect.topright, (1,-1))
        head_rect_left = pygame.FRect(self.rect.topleft, (-1,-1))
        ...
        head_rect_right.collidelist(self.collision_rects) > -1 and self.direction > 0 or\
        head_rect_left.collidelist(self.collision_rects) > -1 and self.direction < 0:
            self.direction *= -1
...
class Shell(pygame.sprite.Sprite):
    ...
    def state_management(self):
        ...
        player_near = shell_pos.distance_to(player_pos) < 650
...
class Pearl(pygame.sprite.Sprite):
    def __init__(self, pos, groups, surf, direction, speed):
        ...
        super().__init__(groups)
        self.image = surf
        self.rect = self.image.get_frect(center = pos + vector(100 * direction, 0))
